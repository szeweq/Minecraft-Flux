...
public final class U {
	...
	static void registerItemMultiModels(Item item, int m) {
		...
		for (int i = 0; i < m; i++) {
			...
			ModelResourceLocation mrl = new ModelResourceLocation(item.getUnlocalizedName(is).substring(5), "inventory");
